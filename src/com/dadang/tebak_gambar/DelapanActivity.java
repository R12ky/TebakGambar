package com.dadang.tebak_gambar;
...
public class DelapanActivity extends Activity {
	EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 public void cekJawaban(View v){
	    	String jawabanBenar = "RACUN DUNIA";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),SembilanActivity.class);
	    		startActivity(i);
	    	}else{
	    		// pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.delapan, menu);
		return true;
	}
