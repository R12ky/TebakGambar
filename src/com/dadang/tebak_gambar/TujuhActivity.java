...
public class TujuhActivity extends Activity {
	EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 public void cekJawaban(View v){
	    	String jawabanBenar = "KAPAL TERBANG";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),DelapanActivity.class);
	    		startActivity(i);
	    	}else{
	    		// pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tujuh, menu);
		return true;
	}
