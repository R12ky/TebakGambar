...
public class EnamActivity extends Activity {
	EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 public void cekJawaban(View v){
	    	String jawabanBenar = "GUDANG SUSU";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),TujuhActivity.class);
	    		startActivity(i);
	    	}else{
	    		// pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.enam, menu);
		return true;
	}
