...
public class EmpatActivity extends Activity {
	EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 public void cekJawaban(View v){
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),LimaActivity.class);
	    		startActivity(i);
	    	}else{
	    		// pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.empat, menu);
		return true;
	}
