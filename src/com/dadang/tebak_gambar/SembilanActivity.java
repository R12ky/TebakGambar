...
public class SembilanActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 public void cekJawaban(View v){
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),SepuluhActivity.class);
	    		startActivity(i);
	    	}else{
	    		// pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sepuluh, menu);
		return true;
	}
